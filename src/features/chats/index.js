...
function Transactions(){
    ...
    return(
        <>
            <TitleCard title="Customer Chats" topMargin="mt-2" TopSideButtons={<TopSideButtons applySearch={applySearch} applyFilter={applyFilter} removeFilter={removeFilter}/>}>
                    ...
                    <div class="w-2/3 border flex flex-col">
                        ...
                        <div class="py-2 px-3">
                            ...
                            <div class="flex justify-center mb-2">
                                <div class="rounded py-2 px-4 bg-indigo-500 ">
                            ...
                            <div class="flex mb-2">
                                <div class="rounded py-2 px-3 bg-indigo-500 ">
